...
# Updated to work with python 3 standalone in 2024 as part of an experiment
...
def motorcontrol():
        ...
        for pscheck in postsynaptic:
                if pscheck[:3] == "MVL" or pscheck[:3] == "MDL":
                   accumleft += postsynaptic[pscheck]
                   postsynaptic[pscheck] = 0 #after being read, these values are zeroed
                elif pscheck[:3] == "MVR" or pscheck[:3] == "MDR":
        ...
        if new_speed > 150:
                ...
                new_speed = 75
        print("Left: %d Right: %d Speed: %d" % (accumleft, accumright, new_speed))
